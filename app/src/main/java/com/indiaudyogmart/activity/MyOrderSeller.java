...
public class MyOrderSeller extends AppCompatActivity {
    ...
    private void init() {
        ...
        if (CommonFunctions.checkConnection(MyOrderSeller.this)) {
            getMyOrderSellerList();
        }
        order.setLayoutManager(new LinearLayoutManager(MyOrderSeller.this));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void getMyOrderSellerList() {
        try {
            if( CommonFunctions.checkConnection(MyOrderSeller.this)) {
                CommonFunctions.createProgressBar(MyOrderSeller.this, getString(R.string.msg_please_wait));
                LoginResponse loginResponse = CommonFunctions.getloginresponse(MyOrderSeller.this);
                ...
                AndroidNetworking.get(url)
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (myOrderSellerResponse.status) {
                                ...
                                Toast.makeText(MyOrderSeller.this, myOrderSellerResponse.message, Toast.LENGTH_SHORT).show();
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    public void onError(ANError anError) {
                        try {
                            CommonFunctions.destroyProgressBar();
                            Toast.makeText(MyOrderSeller.this, R.string.msg_server_error, Toast.LENGTH_SHORT).show();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
