...
public abstract class ProductModelResp {
    ...
    public static class DataEntity {
        @Expose
        @SerializedName("mart_orders")
        public List<MartOrdersEntity> martOrders;
        @Expose
        @SerializedName("mart_new_orders_count")
        public int martNewOrdersCount;
    }

    public static class MartOrdersEntity {
        @Expose
