package com.indiaudyogmart.utils;
...
public class PhotoFullPopupWindow extends PopupWindow {
    ...
    public PhotoFullPopupWindow(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap) {
        super(((LayoutInflater) ctx.getSystemService(LAYOUT_INFLATER_SERVICE)).inflate( R.layout.fullscreen_image, null), ViewGroup.LayoutParams.MATCH_PARENT,
