...
import com.indiaudyogmart.model.IndustriesResponse.DataEntity;

import java.util.ArrayList;
import java.util.List;

public class IndustriesAdapter extends RecyclerView.Adapter<IndustriesAdapter.MyViewHolder> {
    private Context mContext;
   AdapterCallback adapterCallback;
    String def_lang;
    private List<DataEntity> mData=new ArrayList<>();

    public IndustriesAdapter(Context mContext, List<DataEntity> mData, AdapterCallback adapterCallback1, String lang) {
