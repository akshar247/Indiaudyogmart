...
public class MyOrderBuyerAdapter extends RecyclerView.Adapter<MyOrderBuyerAdapter.MyViewHolder> {
    ...
    public MyOrderBuyerAdapter(Context mContext, List<MyOrderSellerResponse.MartOrdersEntity> mData, AdapterCallback adapterCallback1, String lang) {
