...
public class MyQuoteDetailMessageAdapter extends RecyclerView.Adapter<MyQuoteDetailMessageAdapter.MyViewHolder> {
    private Context mContext;
    private List<QuoyeDetailResp.MessagesEntity> mData;
    AdapterCallback adapterCallback;
    String def_lang;


    public MyQuoteDetailMessageAdapter(Context mContext, List<QuoyeDetailResp.MessagesEntity> mData, AdapterCallback adapterCallback1, String lang) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        try {
            final QuoyeDetailResp.MessagesEntity dataEntitytemp = mData.get(position);
    ...
    public interface AdapterCallback {
        void onSubcategoryClick(QuoyeDetailResp.MessagesEntity items);

        void onSubcategoryViewAllClick(QuoyeDetailResp.MessagesEntity items);
    }
