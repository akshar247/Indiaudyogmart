...
import com.indiaudyogmart.utils.PhotoFullPopupWindow;

import java.util.ArrayList;
import java.util.List;
import java.util.NoSuchElementException;

public class ProductPageFlipperAdapter extends PagerAdapter {

    private Activity activity;
    private LayoutInflater layoutInflater;
    public List<ProductResponse.ProductImagesEntity> data=new ArrayList<>();
    HomeData homeData;
    public ProductPageFlipperAdapter(Activity context, List<ProductResponse.ProductImagesEntity> data) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        String url= IndiaMartConfig.product_path +"/"+data.get(position).image;
      ...
      //  scaleImage(iv_contain);
        iv_contain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    new PhotoFullPopupWindow(activity, R.layout.fullscreen_image, iv_contain, url, null);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
